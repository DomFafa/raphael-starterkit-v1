...
export const SUBSCRIPTION_TIERS: ProductTier[] = [
  {
    name: "Starter",
    id: "tier-hobby",
    productId: "prod_5eESI6GsssNIuLbqVxYfrz", // $11 monthly subscription
    priceMonthly: "$11",
  ...
  },
  {
    name: "Business",
    id: "tier-pro",
    productId: "prod_5eESI6GsssNIuLbqVxYfrz", // $29 monthly subscription (测试产品)
    priceMonthly: "$29",
  ...
  },
  {
    name: "Enterprise",
    id: "tier-enterprise",
    productId: "prod_5eESI6GsssNIuLbqVxYfrz", // $99 monthly subscription
    priceMonthly: "$99",
...
export const CREDITS_TIERS: ProductTier[] = [
  {
    name: "Basic Package",
    id: "tier-3-credits",
    productId: "prod_5eESI6GsssNIuLbqVxYfrz", // $9 one-time purchase
    priceMonthly: "$9",
  ...
  },
  {
    ...
    id: "tier-6-credits",
    productId: "prod_5eESI6GsssNIuLbqVxYfrz", // $13 one-time purchase
    priceMonthly: "$13",
  ...
  },
  {
    ...
    id: "tier-9-credits",
    productId: "prod_5eESI6GsssNIuLbqVxYfrz", // $29 one-time purchase
    priceMonthly: "$29",
